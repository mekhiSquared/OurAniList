  ...
  return (
    <>
      ...
      <div style={{ display: "flex", gap: "2rem", flexWrap: "wrap" }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <FontAwesomeIcon icon={faTrophy} style={{ color: "#C0C0C0" }} />
              ...
              >
                <FontAwesomeIcon icon={faLeaf} style={{ color: "#32CD32" }} />
        ...
        <div style={{ width: "1250px", marginLeft: "100px" }}>
          <div
            style={{
              display: "flex",
              marginTop: "50px",
          ...
          >
            {sections.map((section) => (
              <div
                key={section.id}
                style={{
                  color: activeSection === section.id ? "#eff1ed" : "#081c15",

                  cursor: "pointer",
                  padding: "1rem",
                  marginRight: "1rem",
                  borderBottom:
                    activeSection === section.id ? "3px solid #A7C957" : "none",
                  backgroundColor:
                    activeSection === section.id ? "#A7C957" : "#eff1ed",
