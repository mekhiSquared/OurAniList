...
const AnimeSpecsPage = () => {
	...
	const anime = allAnime.find(anime => anime.mal_id === Number(id)) ?? {};
	useEffect(() => {
		// this is here to prevent a user from trying to load a SpecsPage for an anime that doesnt exist
		// navigates back to the home page
		if (!anime.mal_id) navigate("/");
	}, []);
